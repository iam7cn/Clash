...
测试配置 [导入CFW](clash://install-config?url=https://cdn.jsdelivr.net/gh/iam7cn/Clash@main/Profiles/test.yaml) 

https://cdn.jsdelivr.net/gh/iam7cn/Clash@main/Profiles/test.yaml
